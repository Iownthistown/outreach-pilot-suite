      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <ScrollAnimationWrapper key={index} delay={index * 75}>
              <div className="bg-card border border-primary/20 rounded-2xl p-6 shadow-card backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-xl hover:border-primary/40 cursor-pointer group">
                {/* Rating */}
