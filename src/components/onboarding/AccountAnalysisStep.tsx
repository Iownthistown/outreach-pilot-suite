  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 h-20 text-center flex flex-col justify-center">
        <h2 className="text-lg sm:text-xl font-bold text-foreground">AI Account Analysis</h2>
        <p className="text-xs sm:text-sm text-muted-foreground">
          Analyzing your Twitter account to optimize bot settings
        </p>
        {canContinue && (
          <div className="flex items-center justify-center gap-1 text-xs text-primary bg-primary/10 px-2 py-1 rounded-lg animate-fade-in mt-1">
            <Clock className="w-3 h-3" />
            <span className="hidden sm:inline">Analysis continues in background</span>
            <span className="sm:hidden">Can continue</span>
          </div>
        )}
      </div>
